...
public class AuctionRegistryController {
    ...
    public boolean createAuction(@PathVariable int itemId, @PathVariable int paymentId) throws Exception {
        return service.create(itemId, paymentId, Context.getPrincipalId());
    }
}
